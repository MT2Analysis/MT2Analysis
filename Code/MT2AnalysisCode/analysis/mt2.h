...
public :
   ...
   Float_t         jet_btagCSV[48];   //[njet]
   Float_t         jet_rawPt[48];   //[njet]
   Float_t         jet_mcPt[48];   //[njet]
   Int_t           jet_mcFlavour[48];   //[njet]
   Int_t           jet_mcMatchId[48];   //[njet]
   Int_t           jet_mcMatchFlav[48];   //[njet]
   Float_t         jet_area[48];   //[njet]
   Int_t           jet_puId[48];   //[njet]
   Int_t           jet_id[48];   //[njet]
   Int_t           nlep;
   ...
   Float_t         lep_edxy[3];   //[nlep]
   Float_t         lep_edz[3];   //[nlep]
   Float_t         lep_ip3d[3];   //[nlep]
   Float_t         lep_sip3d[3];   //[nlep]
   Int_t           lep_tightId[3];   //[nlep]
   Int_t           lep_convVeto[3];   //[nlep]
   Int_t           lep_lostHits[3];   //[nlep]
   Int_t           lep_looseIdSusy[3];   //[nlep]
   Float_t         lep_relIso03[3];   //[nlep]
   Float_t         lep_relIso04[3];   //[nlep]
   Float_t         lep_chargedHadRelIso03[3];   //[nlep]
   Float_t         lep_chargedHadRelIso04[3];   //[nlep]
   Int_t           lep_convVetoFull[3];   //[nlep]
   ...
   Float_t         lep_mvaId[3];   //[nlep]
   Float_t         lep_mvaIdTrig[3];   //[nlep]
   Float_t         lep_nStations[3];   //[nlep]
   Float_t         lep_trkKink[3];   //[nlep]
   Int_t           lep_trackerLayers[3];   //[nlep]
   Int_t           lep_pixelLayers[3];   //[nlep]
   Float_t         lep_mvaTTH[3];   //[nlep]
   Float_t         lep_jetPtRatio[3];   //[nlep]
   Float_t         lep_jetBTagCSV[3];   //[nlep]
   Float_t         lep_jetDR[3];   //[nlep]
